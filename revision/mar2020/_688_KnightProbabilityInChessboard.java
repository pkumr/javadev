...
* is (0, 0), and the bottom-right square is (N-1, N-1).
*
...
* chessboard. Return the probability that the knight remains on the board after it has
* stopped moving.
*
* Example:
*
* Input: 3, 2, 0, 0
* Output: 0.0625
* Explanation: There are two moves (to (1,2), (2,1)) that will keep the knight on the
* board. From each of those positions, there are also two moves that will keep the knight
* on the board.
*
