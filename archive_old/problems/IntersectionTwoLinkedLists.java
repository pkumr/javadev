...
* the two lists intersect). From the head of A, it reads as [4,1,8,4,5]. From the head
* of B, it reads as [5,0,1,8,4,5]. There are 2 nodes before the intersected node in A;
